...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'calendar' | 'clients' | 'payments' | 'availability' | 'settings'>('calendar')
  ...
  }, [authenticated, activeTab, fetchCalendarData, fetchAvailability, fetchClients, fetchSettings])
      ...
      <main className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        {activeTab === 'settings' && (
          <div className="max-w-2xl mx-auto">
            <h2 className="font-heading text-2xl text-brand-dark mb-1">Settings</h2>
            <p className="text-gray-500 mb-8">Manage your website settings and social media links.</p>
            ...
            <form onSubmit={async (e) => {
              ...
              await updateSiteSettings({
                social_facebook: (fd.get('social_facebook') as string) || '',
                social_instagram: (fd.get('social_instagram') as string) || '',
                social_tiktok: (fd.get('social_tiktok') as string) || '',
              })
              await fetchSettings()
              ...
              <div className="bg-white rounded-2xl border border-brand-border p-6 space-y-5">
                <h3 className="text-sm font-semibold text-brand-dark uppercase tracking-wider">Social Media Links</h3>
                <p className="text-sm text-gray-400 -mt-3">Paste the full URL for each platform. Leave blank to hide.</p>
                ...
                <div>
                  ...
                  <input name="social_facebook" defaultValue={siteSettings.social_facebook || ''}
                    placeholder="https://facebook.com/yourpage"
                    className="w-full px-4 py-3 rounded-xl border border-brand-border bg-white text-brand-dark text-sm placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-dark/30 transition" />
                </div>
                ...
                <div>
                  ...
                  <input name="social_instagram" defaultValue={siteSettings.social_instagram || ''}
                ...
                <div>
                  ...
                  <input name="social_tiktok" defaultValue={siteSettings.social_tiktok || ''}
                ...
                <div className="flex items-center gap-3 pt-2">
                  <button type="submit" disabled={savingSettings}
                    className="px-6 py-2.5 bg-brand-dark text-white text-sm rounded-lg hover:bg-[#2a2a2a] transition disabled:opacity-40">
